...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, M0_DIR1_Pin|M0_DIR2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, M3_DIR1_Pin|M3_DIR2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : M0_DIR1_Pin M0_DIR2_Pin */
  GPIO_InitStruct.Pin = M0_DIR1_Pin|M0_DIR2_Pin;
  ...
  /*Configure GPIO pins : M3_DIR1_Pin M3_DIR2_Pin */
  GPIO_InitStruct.Pin = M3_DIR1_Pin|M3_DIR2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : Oled_RES_Pin Oled_DC_Pin Oled_BLK_Pin */
  GPIO_InitStruct.Pin = Oled_RES_Pin|Oled_DC_Pin|Oled_BLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
