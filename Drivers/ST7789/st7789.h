...
/* Pin connection*/
#define ST7789_RST_PORT Oled_RES_GPIO_Port
#define ST7789_RST_PIN  Oled_RES_Pin
#define ST7789_DC_PORT  Oled_DC_GPIO_Port
#define ST7789_DC_PIN   Oled_DC_Pin

#ifndef CFG_NO_CS
#define ST7789_CS_PORT  Oled_CS_GPIO_Port
#define ST7789_CS_PIN   Oled_CS_Pin
#endif

/* If u need Backlight control, uncomment below */
#define BLK_PORT Oled_CS_GPIO_Port
#define BLK_PIN  Oled_CS_Pin
